...
from densenet_sb import DenseNet
import matplotlib.pyplot as plt
import numpy as np
from resnet_sb import ResNet, BasicBlock, Bottleneck
...
train_loader = DataLoader(mydata_sb, batch_size = 4, shuffle = True)
if __name__ == "__main__":
# 创建model，默认是torch.FloatTensor
    #device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    model = ResNet(BasicBlock, [3, 4, 6, 3], num_classes=3, include_top=True)  
