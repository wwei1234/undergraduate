...
from ResNet_hn import ResNet, BasicBlock, Bottleneck
...
# 创建model，默认是torch.FloatTensor
    ...
    model = ResNet(BasicBlock, [3, 4, 6, 3], num_classes=3, include_top=True)                                                    #.to(device)
